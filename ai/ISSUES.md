...
Acest proiect folosește [GitHub Issues](https://github.com/peviitor-scrapers/nova-power-gas-sa-python-scraper/issues) pentru a urmări munca.
...
Vezi [toate issue-urile](https://github.com/peviitor-scrapers/nova-power-gas-sa-python-scraper/issues).
...
`18680651` and the failing endpoint.
