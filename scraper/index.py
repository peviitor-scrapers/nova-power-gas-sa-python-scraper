"""
NOVA Power & Gas applytojob Scraper — derived from the ELECTROGRUP Python template.

Scrapes NOVA Power & Gas job listings from the group applytojob board (electrogrup.applytojob.com) filtered by
...
def main(root=None):
    ...
    print(f"Jobs scraped from the NOVA Power & Gas applytojob board: {scraped_count}")
