...
```bash
git clone git@github.com:peviitor-scrapers/nova-power-gas-sa-python-scraper.git
cd nova-power-gas-sa-python-scraper
...
[peviitor-scrapers/nova-power-gas-sa-python-scraper/issues](https://github.com/peviitor-scrapers/nova-power-gas-sa-python-scraper/issues).
